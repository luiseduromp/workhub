  ...
  return (
    <main >
      <section className="w-full px-8 md:px-0 md:w-5/6 xl:w-3/4 mx-auto pb-15 pt-20 text-center">
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-semibold inline-block bg-linear-65 from-purple-500 to-pink-500 text-transparent bg-clip-text">WorkHub</h1>
